  ...
  if(plotName == "Plot of points distribution"){
    ...
    purrr::map (1:length(result),function(i){
      ...
      if(nrow(noOfTrueFalse)==2){
        ...
        anomaliesCountPlot[[i]] <- ggplot2::ggplot(noOfTrueFalse, ggplot2::aes(x=IsTrue, y=Frequency,fill=IsTrue)) +
          ggplot2::geom_bar(stat = "identity")+
          ggplot2::labs(title="Distribution of points for the rule", 
              y = "Count")
    ...
    purrr::map (1:length(result),function(ruleNum){
      ...
      if(class(intermediateOutput)=="list"){
        ...
        plotAnomalies[[ruleNum]] <- ggplot2::ggplot(intermediateOutput, ggplot2::aes(x=Group, y=values,fill="blue"))+
          ggplot2::geom_bar(stat = "identity")+
